...
-- ========== [ FAST GOLD FARM MODULE ] ==========
-- Полные данные маршрута из файла:
...
-- Создание кнопки Fast Gold Farm
Tabs.FarmGold:CreateButton({
    Title = "FAST Gold Farm (Load Route)",
    Callback = function()
        if FAST_GOLD_JSON_DATA == nil then
            warn("FAST_GOLD_JSON_DATA NOT FOUND!")
            return
        end
        print("FAST GOLD FARM DATA LOADED. Points: ", #game:GetService("HttpService"):JSONDecode(FAST_GOLD_JSON_DATA).position)
    end
})
