...
local function StartFastGoldFarm()
    ...
    -- Начинаем лететь к первой координате
    ...
    task.spawn(function()
                ...
                if resource:IsA("Model") then
                    ...
                    if entityID then
                        ...
                        if name:match("[Gg]old") or name:match("[Oo]re") then
                            ...
                            if primaryPart then
                                local distance = (rootPos - primaryPart.Position).Magnitude
                                if distance <= searchDistance then
                                    table.insert(goldList, {
                                        Model = resource,
        ...
        local breakCooldown = 0.001
        local lastSearchTime = 0
        local searchCooldown = 0.15
        local lastPickupTime = 0
        local pickupCooldown = 0.05
        local cachedGoldList = {}
